...
public class CoordinatesParserTestCase {
	...
	public void testParseLatitude() {
		...
		// strings Double.MAX_VALUE is assigned. 
		...
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLatitude(latitudeString1), 0.001f);
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLatitude(latitudeString2), 0.001f);
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLatitude(latitudeString3), 0.001f);
	...
	public void testParseLongitude() {
		...
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLongitude(longitudeString1), 0.001f);
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLongitude(longitudeString2), 0.001f);
		assertEquals(Double.MAX_VALUE, CoordinatesParser.parseLongitude(longitudeString3), 0.001f);
