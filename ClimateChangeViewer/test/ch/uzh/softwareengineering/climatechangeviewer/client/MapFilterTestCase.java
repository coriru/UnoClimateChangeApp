...
public class MapFilterTestCase extends GWTTestCase {
	...
	public void testSetFilterValues() {
		...
		filter.getPeriod1QueryInputBox().setText("1900");
		filter.getPeriod2QueryInputBox().setText("1910");
		...
		// entered year2.
		filter.getPeriod1QueryInputBox().setText("1990");
		filter.getPeriod2QueryInputBox().setText("1999");
